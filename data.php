...
<header class="p-3 bg-dark text-white">
  <div class="container">
    ...
    ?>
      ...
      <br />
<p> We pull data from these sources: </p>
<br />
<table>
  <tr>
    <th> <a href="https://www.sec.gov/data/foiadocsfailsdatahtm" class="nav-link px-2 text-secondary">https://www.sec.gov/data/foiadocsfailsdatahtm - updated every morning at midnight.</a> </th>
  </tr>
